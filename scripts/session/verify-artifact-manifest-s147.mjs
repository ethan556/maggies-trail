...
const root=resolve(import.meta.dirname,'../..'),output='SESSION147_ARTIFACTS.json';
...
if(manifest.session!==147||manifest.root!=='maggies-trail-session-147')errors.push('manifest identity mismatch');
