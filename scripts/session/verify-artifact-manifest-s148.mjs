...
const root=resolve(import.meta.dirname,'../..'),output='SESSION148_ARTIFACTS.json';
...
if(manifest.session!==148||manifest.root!=='maggies-trail-session-148')errors.push('manifest identity mismatch');
