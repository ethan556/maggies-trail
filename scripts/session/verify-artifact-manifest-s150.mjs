...
const root=resolve(import.meta.dirname,'../..'),output='SESSION150_ARTIFACTS.json';
...
if(manifest.session!==150||manifest.root!=='maggies-trail-session-150')errors.push('manifest identity mismatch');
