...
const lessonsDirectory = join(process.cwd(), "content", "courses", "shapes-build-k", "lessons");
const targets = [
  { lessonId: "kgb-01-01", stepId: "k2", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-01-02", stepId: "ch1", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-01-04", stepId: "k2", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-02-04", stepId: "k2", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-02-05", stepId: "k1", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-02-05", stepId: "k2", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-03-01", stepId: "k1", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-03-01", stepId: "k2", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
  { lessonId: "kgb-03-02", stepId: "k1", canonicalIds: ["o0", "o1", "o2", "o3"], correctId: "o0" },
];

function fail(message) {
  throw new Error(`S302 shapes-build-k choice-order repair: ${message}`);
}
...
console.log(`S302 shapes-build-k choice-order repair: ${changed.length ? `updated ${changed.join(", ")}` : "already current"}`);
