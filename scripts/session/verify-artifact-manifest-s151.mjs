...
const root=resolve(import.meta.dirname,'../..'),output='SESSION151_ARTIFACTS.json';
...
if(manifest.session!==151||manifest.root!=='maggies-trail-session-151')errors.push('manifest identity mismatch');
