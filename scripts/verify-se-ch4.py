#!/usr/bin/env python3
"""Independent re-derivation of systems-equations Chapter 4 (Word Problems).
...
def _selftest():
    ...
    # Ch4 word-problem systems (all one-solution, integer)
    for sysstr, exp in [
        ("x + y = 12 and x - y = 4", (8, 4)),
        ("x + y = 20 and x - y = 6", (13, 7)),
        ("x + y = 18 and x - y = 4", (11, 7)),
        ("x + y = 28 and x - y = 8", (18, 10)),
        ("x + y = 15 and x - 2y = 0", (10, 5)),
        ("x + y = 40 and x - 4y = 0", (32, 8)),
        ("x + y = 12 and 10x + 5y = 95", (7, 5)),
        ("x + y = 9 and 8x + 5y = 57", (4, 5)),
        ("x + y = 12 and 10x + 6y = 92", (5, 7)),
        ("x + y = 8 and 25x + 10y = 125", (3, 5)),
        ("x + y = 10 and 5x + 8y = 68", (4, 6)),
        ("x + y = 9 and 12x + 8y = 88", (4, 5)),
        ("x + y = 10 and y = 3x - 2", (3, 7)),
        ("3x + 2y = 12 and 3x - y = 3", (2, 3)),
        ("x + y = 9 and x - y = 3", (6, 3)),
        ("x + y = 12 and 3x + 2y = 31", (7, 5)),
        ("x + y = 11 and 9x + 6y = 84", (6, 5)),
    ]:
        got = one(sysstr)
        assert got == (F(exp[0]), F(exp[1])), (sysstr, got, exp)
...
def main():
    ...
    fails = 0
    checked = 0
    for f in sorted(glob.glob("content/courses/systems-equations/lessons/se-04-*.json")):
        d = json.load(open(f))
        lid = d["id"]
