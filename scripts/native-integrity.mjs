...
const walk = (dir, accept = () => true) => {
  ...
  for (const name of readdirSync(dir)) {
    if (["node_modules", ".next", ".git", "coverage", "test-results", "playwright-report"].includes(name)) continue;
...
for (const name of ["node_modules", ".next", ".cml-build", "coverage", "test-results", "playwright-report", ".turbo"]) {
