...
if (authority.decisionCount !== 42 || authority.validDecisionCount !== 42 || authority.invalidDecisionCount !== 0) {
  errors.push(`authority totals ${authority.validDecisionCount}/${authority.decisionCount}, invalid ${authority.invalidDecisionCount}`);
}
if (authority.statusCounts.rejected !== 40 || authority.statusCounts.partial !== 2 || authority.statusCounts.candidate !== 6079) {
