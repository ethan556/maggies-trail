...
// g5d-01-04/c1 and g5d-03-01/c2 bodies were subsequently strengthened by commit 992b590 (S318: 56
// withheld-figure P0s cleared) with a concrete worked example; figure bindings, alignment, and the
// body===narration invariant are unchanged (git show 992b590 confirms these are the only diffs).
const repairs = [
  ["g5d-01-04", "c1", "dpv-trailing-zero", "Zeros written at the far right of a decimal don't add value — 0.5, 0.50, and 0.500 are the same amount. Use extra trailing zeros to line up place values before subtracting two decimals."],
  ...
  ["g5d-03-01", "c2", "pv4-times10-shift", "A power-of-ten shift means multiplying every digit's place by the same amount, the way 34 becomes 340. Multiply the dividend and divisor by that same shift together before dividing."],
