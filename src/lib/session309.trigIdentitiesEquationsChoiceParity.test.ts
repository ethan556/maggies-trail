...
const choices = [
  ...
  ["ti-03-02", "k3", "check", "6c092fa92716f1b73d5e66d462211f69b2cb377a8e3c710c0ec9c45052e70b93", ["cos θ, since the sine term survives the expansion.", "sin θ, if the cofunction relation is reversed.", "1 − sin θ, if the subtraction formula is misread."]],
] as const;
