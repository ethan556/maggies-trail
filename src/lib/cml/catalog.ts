...
export const CML_ENGINE_PROFILES: Partial<Record<TWidget["type"], EngineCMLProfile>> = {
  ...
  derivativeRuleLab: { kernel:"covariation", role:"flagship", actionGoal:"Change local input increments or nested rates and expose the mechanism that produces derivative rules.", invariants:["first-order-change-survives-limit","nested-rates-multiply"], misconceptions:["differentiate-factors-separately","chain-rule-adds-rates"], representations:["diagram","table","graph","symbolic","language"] },
  ...
  secantSlope: { kernel:"covariation", role:"supporting", actionGoal:"Shrink the interval between two points and compare secant slope with the limiting tangent slope.", invariants:["difference-quotient-measures-average-rate","tangent-is-secant-limit"], misconceptions:["derivative-is-y-value","zero-gap-can-be-substituted-directly"], representations:["graph","table","symbolic","language"] },
